...
export class ProductsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiProductsProductsFocusAreaGet(focusArea: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<AllProductsResponseModel>;
    public apiProductsProductsFocusAreaGet(focusArea: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<HttpResponse<AllProductsResponseModel>>;
    public apiProductsProductsFocusAreaGet(focusArea: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<HttpEvent<AllProductsResponseModel>>;
    public apiProductsProductsFocusAreaGet(focusArea: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<any> {
        ...
        return this.httpClient.get<AllProductsResponseModel>(`${this.configuration.basePath}/api/Products/products/${encodeURIComponent(String(focusArea))}`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
